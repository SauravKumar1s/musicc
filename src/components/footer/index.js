    ...
    <div className=" px-4 container mt-20 mx-auto">
      <div className=" sm:flex gap-24 items-start">
        <div className=" basis-[30%]  ">
          <Typography
            variant={"h1"}
            className="uppercase text-white_300 sm:leading-[50px] font-bold italic"
          >
            We would love to hear form YOu
          </Typography>
          <div className="mt-[40px]">
            <p className="sm:text-[14px] leading-0 text-white_100 font-light">
            ...
            <div className=" border-t-2  mt-4 border-white_300">
              <h2 className=" text-[16px] sm:text-[28px] mt-3 text-white_300 font-semibold italic">
                contact@lowfied.com
              </h2>
            </div>
          </div>
        ...
        <div className=" hidden sm:block uppercase basis-[10%] text-white_300  text-[20px]   font-semibold"></div>
        ...
        <div className=" hidden sm:block basis-[20%] uppercase text-white_300 text-[20px]   font-semibold">
          ...
          <div className="sm:text-[14px] text-[8px]  mt-3 sm:mt-[50px]  leading-0 text-white_100 font-light">
            We are Lowfied and we make bangers. We make sure that we sound
            delicious and we always blow minds.Don't get us wrong, we actually
            do blow minds. Try us, satisfaction guaranteed.
          </div>
